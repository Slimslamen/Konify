...
function Shipping({ index, picture, isSelected, onClick }) {
  return (
    <div  onClick={() => onClick(index)} className="w-4/5 md:w-3/5 md:h-36 p-10 pb-20 md:p-10 border rounded-lg m-5 relative">
      ...
      <h3 className="font-semibold text-sm md:text-lg">Utlämningsställe - Postnord</h3>
      <p className="text-slate-400 text-sm md:text-md">39 SEK 1-3 arbetsdagars leverans</p>
      <img
        src={`${picture}`}
        alt="Postnord"
